...
class CloudTaskBean {
  ...
  static CloudTaskBean fromMap(Map<String, dynamic> map) {
    CloudTaskBean cloud_task_bean = new CloudTaskBean();
    cloud_task_bean.description = map['description'];
    cloud_task_bean.status = map['status'];
    cloud_task_bean.taskList = TaskBean.fromNetMapList(map['taskList']);
    return cloud_task_bean;
  }
